...
def test_amplitudes(
    ...
    # an assertion-free test can only fail by crashing). Healthy cases measure
    # <= ~1e-6 max MSE on the mini dataset (fp32 logits); a real symmetry break
    # measures >= 1e-2, so 1e-5 leaves an order of magnitude of headroom.
